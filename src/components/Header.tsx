...
export default function Header({ activeTab, user, onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 md:px-6 py-3 flex items-center justify-between sticky top-0 z-40" id="top_header_root">
