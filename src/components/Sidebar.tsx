...
export default function Sidebar({ activeTab, setActiveTab, user, onLogout, isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-slate-300 border-r border-slate-800 flex flex-col justify-between h-screen lg:sticky lg:top-0 shrink-0 transition-transform duration-300 ease-in-out ${
